...
import 'package:mywaylearn/services/auth/auth_provider.dart';
import 'package:mywaylearn/services/auth/auth_user.dart';

// import 'package:test/test.dart' as testobj;
void main() {
  group('Mock Authentication', () {
    ...
    test('Could not be log out if not initialized', () {
      expect(
        provider.logOut(),
    ...
    test('Should be initialized to', () async {
    ...
    test('Create user will get deleget to login function', () async {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (password == 'abc123') throw WrongPasswordAuthException();
